...
#Import Gudz
RUN wget https://raw.githubusercontent.com/Itsunknown-12/TgBot/main/zaid.py
RUN wget https://raw.githubusercontent.com/Itsunknown-12/TgBot/main/requirements.txt
#Start Fumkin
